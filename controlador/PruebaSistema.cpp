...
void ejecutar_pruebas_sistema() {
    ...
    cout << "Mostrando catalogo para verificar orden (Fakemink, offset, Extremoduro, Manolo Garciap):" << endl;
    ...
    cout << "--- PRUEBAS DE INTEGRACION DE USUARIOS ---" << endl;


    cout << "Liberando memoria del Sistema..." << endl;
    delete miApp;
    cout << "=============================================" << endl;
